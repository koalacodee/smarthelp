...
interface SupervisorRegistrationFormProps {
  invitation: any;
  token: string;
}
...
export default function SupervisorRegistrationForm({
  invitation,
  token,
}: SupervisorRegistrationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.username || !formData.password) {
      setRootError("Username and password are required");
      setLoading(false);
      return;
    }
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            >
              Set up your supervisor account to get started
            </motion.p>
          </div>
        </div>
      </motion.div>
        ...
        >
          ...
          >
            <div className="grid grid-cols-1 gap-4">
              {[
                { label: "Name", value: invitation.name, type: "text" },
              ...
              >
                ...
                >
                  {invitation.departmentNames.map(

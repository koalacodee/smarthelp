...
interface AnimatedErrorPageProps {
  title: string;
  message: string;
}
...
export default function AnimatedErrorPage({
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 flex items-center justify-center p-6"
    >
      <motion.div

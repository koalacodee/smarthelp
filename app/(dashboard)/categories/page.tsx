...
export default async function CategoriesPage() {
    ...
    const [categories, subCategories, groupedChunks] = await Promise.all([
    ...
    const knowledgeChunks = groupedChunks.reduce(
        (acc, item) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 p-6">
            <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in duration-300">
                <PageHeader
                    title={isAdmin ? "Categories & Sub-categories" : "Sub-categories"}
                    description="Manage your organizational structure and knowledge base"
                />

...
export const DatePickerHeader: React.FC<DatePickerHeaderProps> = ({
  ...
  const displayedGregorian = calendarType === 'hijri' 
    ? selectedGregorian
    : selectedGregorian;
  const displayedHijri = calendarType === 'gregorian'
  ...
  return (
    <div style={{
      ...
      <h2 style={{
        fontFamily: language === 'ar' ? '"Amiri", serif' : '"Noto Kufi Arabic", sans-serif',
        fontSize: '1.5rem',
        fontWeight: '700',
        color: '#1a1a2e',
        margin: '0.5rem 0',
      ...
      <div style={{
        ...
        {calendarType === 'hijri' 
          ...
          : `${displayedHijri.day} ${HIJRI_MONTHS[displayedHijri.month - 1]} ${displayedHijri.year}`
        }
      </div>
    </div>
  );
